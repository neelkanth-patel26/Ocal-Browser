...
AppVersion=8.9.00
AppVerName=Ocal Browser 8.9.00
...
OutputDir=dist-inno
OutputBaseFilename=Ocal-8.9.00-Setup
...
UninstallDisplayName=Ocal Browser 8.9.00
VersionInfoVersion=8.9.0.0
...
VersionInfoProductVersion=8.9.00
WizardStyle=modern
WizardResizable=no
...
ReleaseNotes=View release notes for v8.5.00
...
Root: HKLM; Subkey: "Software\OcalBrowser"; ValueType: string; ValueName: "Version";      ValueData: "8.5.00";                                              Flags: uninsdeletekey
...
Filename: "https://github.com/neelkanth-patel26/Ocal-Browser/releases/tag/v8.5.00"; Description: "{cm:ReleaseNotes}"; Flags: shellexec postinstall skipifsilent unchecked
