...
AppVersion=8.9.50
AppVerName=Ocal Browser 8.9.50
...
OutputDir=dist-inno
OutputBaseFilename=Ocal-8.9.50-Setup
...
UninstallDisplayName=Ocal Browser 8.9.50
VersionInfoVersion=8.9.5.0
...
VersionInfoProductVersion=8.9.50
WizardStyle=modern
WizardResizable=no
